...
import com.smarthome.control.ui.device.ScheduleControlSheet
...
internal fun FloorDashboardContent(
    ...
    sheetForDevice?.let { marker ->
        ...
        when (marker.type) {
            ...
            DeviceType.LIGHT -> ScheduleControlSheet(
                deviceId = marker.deviceId,
                onDismiss = dismiss,
                onMoveDevice = { move() },
                onViewHistory = history,
 ...
 */
private val SheetTypes =
    setOf(DeviceType.OUTLET, DeviceType.MULTI_SWITCH, DeviceType.APPLIANCE, DeviceType.LIGHT)
